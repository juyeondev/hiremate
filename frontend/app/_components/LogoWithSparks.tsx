...
export default function LogoWithSparks() {
  return (
    <div className="relative">
      <Image src={sparkYellow} alt="" width={23} height={27} className="absolute -bottom-5 -left-23" />
      <Image src={sparkPurple} alt="" width={23} height={27} className="absolute -bottom-3 -right-19" />
      <Image src={sparkYellow} alt="" width={15} height={18} className="absolute -bottom-6 -right-23" />
